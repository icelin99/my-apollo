...
export default class PlanningData {
    ...
    update(world) {
      ...
      console.log('planning_data.js', planningData);
      if (planningData) {
        ...
        //------------------2022.1.22
        if(planningData.singleLight) {

        }

        if(planningData.referenceLine) {

        }

        if(planningData.dpPloyGraph) {

        }

        if(planningData.latticeStImage) {

        }

        if(planningData.autoTuningTrainingData) {

        }

        if(planningData.frontClearDistance) {

        }

        if(planningData.openSpace) {
