...
export default class Dimension {
    ...
    @action updatePlanningDimension() {
      ...
      this.myview.width = (this.pane.width - widthOffset) * 0.47;
      this.myview.height = this.pane.height * 0.3;
    }
    ...
    @action updateSceneDimension() {
      ...
      if (OFFLINE_PLAYBACK) {
        ...
        height = parent.height - PLAYBACK_STYLE.PLAYBACK_CONTROL_HEIGHT * 0.35;
