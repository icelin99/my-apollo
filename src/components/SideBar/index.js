...
// ---------------2022.1.21
import PlanningEvaIcon from 'assets/images/sidebar/planningEva.png';
...
const sidebarIconMapping = {
  ...
  showPlanningEva: PlanningEvaIcon
  // ----------------2022.1.21
};
...
const sidebarLabelMapping = {
  ...
  // ---------------2022.1.21
  showPlanningEva: 'planning Evaluation'
};
    ...
    return (
            <div className="side-bar">
                <div className="main-panel">
                    ...
                    <SideBarButton type="main" {...settings.showPlanningEva} />
                </div>
